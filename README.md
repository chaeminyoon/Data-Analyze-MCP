...
[![Tools](https://img.shields.io/badge/Tools-40-3d6fb6.svg)](#mcp-server-tools-40-total)
[![Claude](https://img.shields.io/badge/Claude-Desktop%20%7C%20Code-d97757.svg)](https://claude.ai/)

[빠른 시작](#quick-start) · [시연](#demo--분석--처리--시각화) · [차트 테마](#chart-themes) · [도구 목록](#mcp-server-tools-40-total) · [LLM 연동 가이드](docs/LLM_INTEGRATION.md)
...
- **40개 전문 도구** — 프로파일링, 전처리(결측/이상치/인코딩/스케일링), 피처 엔지니어링, 정적/인터랙티브 시각화, 가설검정, 모델 비교/평가/튜닝
...
AI:  34행을 제거했습니다. (545, 12) → (511, 12)
     [remove_outliers 호출 — 캐시가 갱신되어 이후 분석은 정제된 데이터 기준]
```

| 처리 전 | 처리 후 |
|:---:|:---:|
| <img src="docs/images/demo_price_before.png" width="100%"> | <img src="docs/images/demo_price_after.png" width="100%"> |
