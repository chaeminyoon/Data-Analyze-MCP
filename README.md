...
[![Tools](https://img.shields.io/badge/Tools-53-2a78d6.svg)](#mcp-server-tools-53-total)
...
[빠른 시작](#quick-start) · [시연](#demo--분석--처리--시각화) · [차트 테마](#chart-themes) · [도구 목록](#mcp-server-tools-53-total) · [LLM 연동 가이드](docs/LLM_INTEGRATION.md)
...
- **53개 전문 도구** — 프로파일링, 전처리(결측/이상치/인코딩/스케일링), 피처 엔지니어링, 정적/인터랙티브 시각화, 구성·비교 차트, 분포·데이터 품질 진단, 가설검정, 모델 비교/평가/튜닝/진단
...
<details>
<summary><b>Composition & Comparison</b> (4) — 구성·비교</summary>
...
<details>
<summary><b>Distribution & Data Quality</b> (4) — 분포·품질 진단</summary>
...
<details>
<summary><b>Machine Learning</b> (7) — 모델링·진단</summary>
